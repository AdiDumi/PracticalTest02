...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private class GetValueButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String valuta = informationTypeSpinner.getSelectedItem().toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getValueButton = (Button)findViewById(R.id.get_value_button);
        getValueButton.setOnClickListener(getValueButtonClickListener);
